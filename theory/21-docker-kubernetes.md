...
## 170. Что такое multi-stage build и зачем он Go-разработчику?
...
## 184. HPA — горизонтальное автомасштабирование (базово)
...
## 185. Как Go-сервис деплоится в k8s: healthcheck, graceful shutdown, SIGTERM
